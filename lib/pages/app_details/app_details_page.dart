...
class AppDetailsPage extends StatelessWidget {
  ...
  Widget _listItem(BuildContext context, String title, String? subtitle) =>
      ListTile(
        title: Text(title),
        subtitle: Text(subtitle == '' || subtitle == null ? 'N/A' : subtitle,
          ...
          if (snapshot.hasData) {
            ...
            return PageScaffold.withScrollableChildren(
              ...
              children: [
                ...
                _listItem(
                    context, 'Build Signature', packageInfo?.buildSignature),
                _listItem(context, 'OS', Platform.operatingSystem),
                _listItem(
                    context, 'OS Version', Platform.operatingSystemVersion),
              ],
            );
          } else {
            return const PageScaffold(
                title: 'App Details', child: CircularProgressIndicator());
          }
        });
  }
}
